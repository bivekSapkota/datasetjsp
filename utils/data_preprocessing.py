...
def create_prompt_formats(example,tokenizer):
    ...
    user_variations = [
        "Instruct: Provide a solution schedule for the Nursing Scheduling problem below.",
        "Task: Provide the steps of a solution for the Nursing Scheduling problem.",
        "Command: Give a detailed solution to tackle the Nursing Scheduling problem."
    ]
    ...
    messages = [
        {"role": "system", "content": "You are expert in Nursing Scheduling Problem"},
